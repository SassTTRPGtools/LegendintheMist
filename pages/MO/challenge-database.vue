<template>
  <div class="min-h-screen bg-gray-900 pb-8 relative">
    ...
    <div class="px-4 py-6 relative z-10 max-w-7xl mx-auto">
      <div class="grid grid-cols-12 gap-4 h-[calc(100vh-140px)] relative">
        
        <!-- Left Panel -->
        <div class="col-span-3 bg-gray-800 rounded-xl shadow-lg border border-cyan-500/30 flex flex-col h-full max-h-full">
        ...
        <!-- Middle Panel -->
        <div class="col-span-6 bg-gray-900 rounded-lg shadow-xl border border-gray-700 flex flex-col h-full max-h-full relative overflow-hidden">
          <div v-if="selectedChallengeData" class="h-full flex flex-col min-h-0">
            ...
            <div class="flex-1 min-h-0 overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900">
              <div class="h-full overflow-y-auto p-6 pt-12 custom-scrollbar" style="scrollbar-gutter: stable;">
                ...
                <div v-if="selectedChallengeData.threatsAndConsequences && selectedChallengeData.threatsAndConsequences.length > 0" class="mb-6">
